...
list = MyList.list([:a, :b, :c]) |> MyList.puts
list2 = MyList.list([:dog, :banana, :prune])
list3 = MyList.list([:apple, :banana])
Con.car(list) |> IO.puts
Con.cdr(list) |> MyList.puts

MyList.memq(:apple, list2) |> MyList.puts
MyList.memq(:apple, MyList.list([:dog, list3, :apple, :pear])) |> MyList.puts
