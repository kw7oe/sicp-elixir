...
exponent_example = MyList.list([:"**", :x, 2])
Diff.deriv(exponent_example, :x) |> MyList.puts

list = MyList.list([:"**", :x, 2])
exponent_ex2 = MyList.list([:*, :a, list])
Diff.deriv(exponent_ex2, :x) |> MyList.puts
