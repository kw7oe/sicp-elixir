...
defmodule MySet do
  ...
  def union_set(set1, set2) do
    cond do
      set2 == nil -> set1
      set1 == nil -> set2
      true ->
        set2 = adjoin_set(car(set1), set2)
...
MySet.union_set(set1, set2) |> MySet.puts
MySet.union_set(set1, nil) |> MySet.puts
MySet.union_set(nil, set2) |> MySet.puts
